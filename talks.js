...
That’s mostly it.`,
  ...
  },
  {
    ...
    description: `Come join the latest chapter in our series of "Learn to P2P" workshops. The focus will be how to build systems that support streaming and sharing of real time data. The workshop will consist of a series of small iterative exercises that will take you through the basics of networking and distributed systems, all the way to learning how you can make your own P2P TV and radio stations.
There will be content for everybody, no matter your skill level.
